...
for problem_loop in range(200):
    ...
    rect_min = [-1000, -1, -1000, -1, -1000, -1, -1000, -1, -1000, -1,
                -1000, -1, -1000, -1, -1000, -1, -1000, -1, -1000, -1]  # constraints for x^0, x^1, u^0, u^1
    rect_max = [1000, 1, 1000, 1, 1000, 1, 1000, 1, 1000, 1,
                1000, 1, 1000, 1, 1000, 1, 1000, 1, 1000, 1, ]  # constraints for x^0, x^1, u^0, u^1
    ...
    n_x = A.shape[1]
    n_u = B.shape[1]
    c_t_x_min = np.array([-1000, -1, -1000, -1, -1000, -1, -1000, -1, -1000, -1])
    c_t_x_max = np.array([1000, 1, 1000, 1, 1000, 1, 1000, 1, 1000, 1])
    c_t_u_min = np.array([-1000, -1, -1000, -1, -1000, -1, -1000, -1, -1000, -1])
    c_t_u_max = np.array([1000, 1, 1000, 1, 1000, 1, 1000, 1, 1000, 1])
    c_N_min = np.array([-1000, -1, -1000, -1, -1000, -1, -1000, -1, -1000, -1])
    c_N_max = np.array([1000, 1, 1000, 1, 1000, 1, 1000, 1, 1000, 1])
